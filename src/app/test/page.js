...
import { GENERIC as fallbackGenerics  } from '@/constants/genericMedicine';
const fetchGenericEquivalents = async (drugName) => {
  const url = `https://rxnav.nlm.nih.gov/REST/RxNorm/approximateTerm.json?term=${encodeURIComponent(drugName)}`;
  try {
