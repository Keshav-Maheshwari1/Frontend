  ...
  return (
    <div className="border rounded-2xl shadow-md hover:shadow-lg transition duration-300 bg-white p-4 h-full flex flex-col">
      <img
        ...
        width={200}
        height={150}
        className="w-full h-48 object-cover mb-4 rounded-lg" // Increased height to 192px (h-48) and used object-cover
      />
      <div className="flex-1">
        <h2 className="text-xl font-semibold text-gray-800">{med.name}</h2>
        <p className="text-gray-600 text-sm line-clamp-2">{med.purpose}</p>
